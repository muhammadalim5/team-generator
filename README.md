...
Because this application won’t be deployed, you’ll need to provide a link to a walkthrough video that demonstrates its functionality and all of the tests passing. Need to submit a link to the video AND add it to the readme of your project.
...
![mobile responsive](./Assets/mobile.jpg  )
